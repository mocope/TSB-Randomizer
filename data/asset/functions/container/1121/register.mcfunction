#> asset:container/1121/register
#
# コンテナの定義データ
#
# @within function asset:container/1121/


execute unless data storage randomizer: Pos unless loaded 155 171 -388 run return 1

# ID (int)
    data modify storage asset:container ID set value 1121
# Pos ([int] @ 3)
