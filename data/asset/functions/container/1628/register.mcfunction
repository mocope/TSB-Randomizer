#> asset:container/1628/register
#
# コンテナの定義データ
#
# @within function asset:container/1628/


execute unless data storage randomizer: Pos unless loaded -146 73 133 run return 1

# ID (int)
    data modify storage asset:container ID set value 1628
# Pos ([int] @ 3)
