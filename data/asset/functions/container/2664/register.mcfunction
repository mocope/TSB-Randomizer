#> asset:container/2664/register
#
# コンテナの定義データ
#
# @within function asset:container/2664/


execute unless data storage randomizer: Pos unless loaded -80 34 226 run return 1

# ID (int)
    data modify storage asset:container ID set value 2664
# Pos ([int] @ 3)
