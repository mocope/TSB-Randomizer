#> asset:container/2367/register
#
# コンテナの定義データ
#
# @within function asset:container/2367/


execute unless data storage randomizer: Pos unless loaded 23 40 -366 run return 1

# ID (int)
    data modify storage asset:container ID set value 2367
# Pos ([int] @ 3)
