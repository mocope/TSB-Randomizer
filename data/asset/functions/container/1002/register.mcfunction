#> asset:container/1002/register
#
# コンテナの定義データ
#
# @within function asset:container/1002/


execute unless data storage randomizer: Pos unless loaded 255 60 -243 run return 1

# ID (int)
    data modify storage asset:container ID set value 1002
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [255, 60, -243]
