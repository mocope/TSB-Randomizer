#> asset:container/2194/register
#
# コンテナの定義データ
#
# @within function asset:container/2194/


execute unless data storage randomizer: Pos unless loaded -28 23 -11 run return 1

# ID (int)
    data modify storage asset:container ID set value 2194
# Pos ([int] @ 3)
