...
execute unless data storage randomizer: Pos unless loaded 21 8 -63 run return 1
...
# ブロック (id(minecraft:block))
    data modify storage asset:container Block set value "minecraft:light_blue_shulker_box[facing=up]"
