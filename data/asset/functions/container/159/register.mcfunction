#> asset:container/159/register
#
# コンテナの定義データ
#
# @within function asset:container/159/


execute unless data storage randomizer: Pos unless loaded -74 -9 150 run return 1

# ID (int)
    data modify storage asset:container ID set value 159
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [-74, -9, 150]
