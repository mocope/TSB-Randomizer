#> asset:container/2670/register
#
# コンテナの定義データ
#
# @within function asset:container/2670/


execute unless data storage randomizer: Pos unless loaded 24 101 -381 run return 1

# ID (int)
    data modify storage asset:container ID set value 2670
# Pos ([int] @ 3)
