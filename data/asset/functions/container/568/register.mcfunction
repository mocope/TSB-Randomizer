...
execute unless data storage randomizer: Pos unless loaded -23 23 -44 run return 1
...
# ブロック (id(minecraft:block))
    data modify storage asset:container Block set value "minecraft:hopper[facing=north]"
