#> asset:container/796/register
#
# コンテナの定義データ
#
# @within function asset:container/796/


execute unless data storage randomizer: Pos unless loaded -195 68 401 run return 1

# ID (int)
    data modify storage asset:container ID set value 796
# Pos ([int] @ 3)
