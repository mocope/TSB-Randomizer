#> asset:container/1995/register
#
# コンテナの定義データ
#
# @within function asset:container/1995/


execute unless data storage randomizer: Pos unless loaded 187 38 -38 run return 1

# ID (int)
    data modify storage asset:container ID set value 1995
# Pos ([int] @ 3)
