#> asset:container/1670/register
#
# コンテナの定義データ
#
# @within function asset:container/1670/


execute unless data storage randomizer: Pos unless loaded -76 58 -294 run return 1

# ID (int)
    data modify storage asset:container ID set value 1670
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [-76, 58, -294]
