#> asset:container/1725/register
#
# コンテナの定義データ
#
# @within function asset:container/1725/


execute unless data storage randomizer: Pos unless loaded 122 39 40 run return 1

# ID (int)
    data modify storage asset:container ID set value 1725
# Pos ([int] @ 3)
