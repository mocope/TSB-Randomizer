#> asset:container/1007/register
#
# コンテナの定義データ
#
# @within function asset:container/1007/


execute unless data storage randomizer: Pos unless loaded 255 60 -242 run return 1

# ID (int)
    data modify storage asset:container ID set value 1007
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [255, 60, -242]
