#> asset:container/994/register
#
# コンテナの定義データ
#
# @within function asset:container/994/


execute unless data storage randomizer: Pos unless loaded 230 61 -267 run return 1

# ID (int)
    data modify storage asset:container ID set value 994
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [230, 61, -267]
