#> asset:container/2453/register
#
# コンテナの定義データ
#
# @within function asset:container/2453/


execute unless data storage randomizer: Pos unless loaded -69 3 49 run return 1

# ID (int)
    data modify storage asset:container ID set value 2453
# Pos ([int] @ 3)
