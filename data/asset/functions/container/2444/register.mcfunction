#> asset:container/2444/register
#
# コンテナの定義データ
#
# @within function asset:container/2444/


execute unless data storage randomizer: Pos unless loaded 295 52 -92 run return 1

# ID (int)
    data modify storage asset:container ID set value 2444
# Pos ([int] @ 3)
