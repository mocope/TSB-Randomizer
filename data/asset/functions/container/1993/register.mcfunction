#> asset:container/1993/register
#
# コンテナの定義データ
#
# @within function asset:container/1993/


execute unless data storage randomizer: Pos unless loaded 177 38 -38 run return 1

# ID (int)
    data modify storage asset:container ID set value 1993
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [177, 38, -38]
