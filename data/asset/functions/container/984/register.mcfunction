#> asset:container/984/register
#
# コンテナの定義データ
#
# @within function asset:container/984/


execute unless data storage randomizer: Pos unless loaded 255 61 -210 run return 1

# ID (int)
    data modify storage asset:container ID set value 984
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [255, 61, -210]
