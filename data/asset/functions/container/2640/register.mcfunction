#> asset:container/2640/register
#
# コンテナの定義データ
#
# @within function asset:container/2640/


execute unless data storage randomizer: Pos unless loaded -203 208 393 run return 1

# ID (int)
    data modify storage asset:container ID set value 2640
# Pos ([int] @ 3)
