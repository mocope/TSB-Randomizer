#> asset:container/2363/register
#
# コンテナの定義データ
#
# @within function asset:container/2363/


execute unless data storage randomizer: Pos unless loaded 23 118 -393 run return 1

# ID (int)
    data modify storage asset:container ID set value 2363
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [23, 118, -393]
