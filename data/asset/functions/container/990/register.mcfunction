#> asset:container/990/register
#
# コンテナの定義データ
#
# @within function asset:container/990/


execute unless data storage randomizer: Pos unless loaded 305 61 -218 run return 1

# ID (int)
    data modify storage asset:container ID set value 990
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [305, 61, -218]
