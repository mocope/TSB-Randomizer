#> asset:container/534/register
#
# コンテナの定義データ
#
# @within function asset:container/534/


execute unless data storage randomizer: Pos unless loaded -74 -9 153 run return 1

# ID (int)
    data modify storage asset:container ID set value 534
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [-74, -9, 153]
