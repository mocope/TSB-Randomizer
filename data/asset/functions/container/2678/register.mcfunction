#> asset:container/2678/register
#
# コンテナの定義データ
#
# @within function asset:container/2678/


execute unless data storage randomizer: Pos unless loaded -213 132 393 run return 1

# ID (int)
    data modify storage asset:container ID set value 2678
# Pos ([int] @ 3)
