#> asset:container/1569/register
#
# コンテナの定義データ
#
# @within function asset:container/1569/


execute unless data storage randomizer: Pos unless loaded 24 118 -393 run return 1

# ID (int)
    data modify storage asset:container ID set value 1569
# Pos ([int] @ 3)
