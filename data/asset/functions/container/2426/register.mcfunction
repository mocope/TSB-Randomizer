#> asset:container/2426/register
#
# コンテナの定義データ
#
# @within function asset:container/2426/


execute unless data storage randomizer: Pos unless loaded 121 39 40 run return 1

# ID (int)
    data modify storage asset:container ID set value 2426
# Pos ([int] @ 3)
