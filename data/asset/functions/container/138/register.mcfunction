#> asset:container/138/register
#
# コンテナの定義データ
#
# @within function asset:container/138/


execute unless data storage randomizer: Pos unless loaded 200 10 -138 run return 1

# ID (int)
    data modify storage asset:container ID set value 138
# Pos ([int] @ 3)
