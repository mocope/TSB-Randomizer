#> asset:container/2248/register
#
# コンテナの定義データ
#
# @within function asset:container/2248/


execute unless data storage randomizer: Pos unless loaded 178 204 -187 run return 1

# ID (int)
    data modify storage asset:container ID set value 2248
# Pos ([int] @ 3)
