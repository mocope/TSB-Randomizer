#> asset:container/1994/register
#
# コンテナの定義データ
#
# @within function asset:container/1994/


execute unless data storage randomizer: Pos unless loaded 182 38 -43 run return 1

# ID (int)
    data modify storage asset:container ID set value 1994
# Pos ([int] @ 3)
