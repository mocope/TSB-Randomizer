#> asset:container/996/register
#
# コンテナの定義データ
#
# @within function asset:container/996/


execute unless data storage randomizer: Pos unless loaded 304 61 -267 run return 1

# ID (int)
    data modify storage asset:container ID set value 996
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [304, 61, -267]
