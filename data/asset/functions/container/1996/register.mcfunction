#> asset:container/1996/register
#
# コンテナの定義データ
#
# @within function asset:container/1996/


execute unless data storage randomizer: Pos unless loaded 182 38 -33 run return 1

# ID (int)
    data modify storage asset:container ID set value 1996
# Pos ([int] @ 3)
