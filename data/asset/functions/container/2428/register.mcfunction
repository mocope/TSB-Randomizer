#> asset:container/2428/register
#
# コンテナの定義データ
#
# @within function asset:container/2428/


execute unless data storage randomizer: Pos unless loaded 87 156 1951 run return 1

# ID (int)
    data modify storage asset:container ID set value 2428
# Pos ([int] @ 3)
    data modify storage asset:container Pos set value [87, 156, 1951]
