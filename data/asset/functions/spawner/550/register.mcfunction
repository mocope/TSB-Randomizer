...
execute unless data storage randomizer: Pos unless loaded 403 34 81 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 550
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [403, 34, 81]
