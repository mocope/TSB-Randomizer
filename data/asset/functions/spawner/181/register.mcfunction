...
execute unless data storage randomizer: Pos unless loaded -24 18 175 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 181
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-24, 18, 175]
