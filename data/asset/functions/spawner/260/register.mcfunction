...
execute unless data storage randomizer: Pos unless loaded -141 94 -129 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 260
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-141, 94, -129]
