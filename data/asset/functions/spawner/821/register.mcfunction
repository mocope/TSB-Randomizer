...
execute unless data storage randomizer: Pos unless loaded 34 66 89 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 821
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [34, 66, 89]
