...
execute unless data storage randomizer: Pos unless loaded 301 52 -88 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 469
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [301, 52, -88]
