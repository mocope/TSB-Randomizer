...
execute unless data storage randomizer: Pos unless loaded 211 126 -95 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 280
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [211, 126, -95]
