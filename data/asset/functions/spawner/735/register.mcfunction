...
execute unless data storage randomizer: Pos unless loaded 58 85 -379 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 735
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [58, 85, -379]
