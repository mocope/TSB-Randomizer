...
execute unless data storage randomizer: Pos unless loaded -119 26 -12 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 520
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-119, 26, -12]
