...
execute unless data storage randomizer: Pos unless loaded 160 10 207 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 223
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [160, 10, 207]
