...
execute unless data storage randomizer: Pos unless loaded -64 166 174 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 432
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-64, 166, 174]
