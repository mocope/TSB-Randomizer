...
execute unless data storage randomizer: Pos unless loaded 182 145 251 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 875
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [182, 145, 251]
