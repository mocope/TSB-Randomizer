...
execute unless data storage randomizer: Pos unless loaded 453 181 -152 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 578
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [453, 181, -152]
