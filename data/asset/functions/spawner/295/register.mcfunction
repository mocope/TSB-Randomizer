...
execute unless data storage randomizer: Pos unless loaded -59 210 398 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 295
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-59, 210, 398]
