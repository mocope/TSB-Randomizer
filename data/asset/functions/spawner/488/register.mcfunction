...
execute unless data storage randomizer: Pos unless loaded 38 42 376 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 488
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [38, 42, 376]
