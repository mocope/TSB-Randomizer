...
execute unless data storage randomizer: Pos unless loaded 98 91 -206 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 344
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [98, 91, -206]
