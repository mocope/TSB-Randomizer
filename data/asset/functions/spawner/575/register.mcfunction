...
execute unless data storage randomizer: Pos unless loaded 438 108 -173 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 575
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [438, 108, -173]
