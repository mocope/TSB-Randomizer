...
execute unless data storage randomizer: Pos unless loaded -145 94 -152 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 259
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-145, 94, -152]
