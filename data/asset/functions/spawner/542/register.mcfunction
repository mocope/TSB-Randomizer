...
execute unless data storage randomizer: Pos unless loaded 426 12 127 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 542
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [426, 12, 127]
