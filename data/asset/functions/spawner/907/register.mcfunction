...
execute unless data storage randomizer: Pos unless loaded 102 149 730 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 907
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [102, 149, 730]
