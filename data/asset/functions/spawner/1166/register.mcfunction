...
execute unless data storage randomizer: Pos unless loaded 77 120 1961 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1166
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [77, 120, 1961]
