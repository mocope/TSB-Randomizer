...
execute unless data storage randomizer: Pos unless loaded 118 147 -575 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 985
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [118, 147, -575]
