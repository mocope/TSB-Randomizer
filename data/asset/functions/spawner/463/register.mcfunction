...
execute unless data storage randomizer: Pos unless loaded 311 42 -90 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 463
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [311, 42, -90]
