...
execute unless data storage randomizer: Pos unless loaded 86 23 139 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 13
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [86, 23, 139]
