...
execute unless data storage randomizer: Pos unless loaded -139 53 72 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 230
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-139, 53, 72]
