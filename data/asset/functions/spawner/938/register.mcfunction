...
execute unless data storage randomizer: Pos unless loaded 206 129 -365 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 938
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [206, 129, -365]
