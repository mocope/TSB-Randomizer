...
execute unless data storage randomizer: Pos unless loaded -148 73 143 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 405
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-148, 73, 143]
