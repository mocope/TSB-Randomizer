...
execute unless data storage randomizer: Pos unless loaded 264 110 -248 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 333
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [264, 110, -248]
