...
execute unless data storage randomizer: Pos unless loaded 230 72 -263 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 343
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [230, 72, -263]
