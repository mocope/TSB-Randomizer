...
execute unless data storage randomizer: Pos unless loaded -80 37 -67 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 43
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-80, 37, -67]
