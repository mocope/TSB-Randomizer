...
execute unless data storage randomizer: Pos unless loaded -13 38 158 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 184
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-13, 38, 158]
