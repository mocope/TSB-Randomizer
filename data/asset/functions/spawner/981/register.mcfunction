...
execute unless data storage randomizer: Pos unless loaded 60 155 -528 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 981
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [60, 155, -528]
