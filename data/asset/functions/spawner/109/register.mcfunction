...
execute unless data storage randomizer: Pos unless loaded -60 33 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 109
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-60, 33, 226]
