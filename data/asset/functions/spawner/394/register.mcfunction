...
execute unless data storage randomizer: Pos unless loaded -212 119 19 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 394
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-212, 119, 19]
