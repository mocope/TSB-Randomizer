...
execute unless data storage randomizer: Pos unless loaded 35 -11 98 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 106
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [35, -11, 98]
