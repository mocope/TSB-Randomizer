...
execute unless data storage randomizer: Pos unless loaded -456 94 44 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1029
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-456, 94, 44]
