...
execute unless data storage randomizer: Pos unless loaded 304 72 -262 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 342
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [304, 72, -262]
