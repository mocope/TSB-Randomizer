...
execute unless data storage randomizer: Pos unless loaded 440 80 -170 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 570
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [440, 80, -170]
