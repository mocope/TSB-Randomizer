...
execute unless data storage randomizer: Pos unless loaded 43 74 325 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 507
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [43, 74, 325]
