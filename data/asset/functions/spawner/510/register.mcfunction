...
execute unless data storage randomizer: Pos unless loaded -9 74 363 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 510
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-9, 74, 363]
