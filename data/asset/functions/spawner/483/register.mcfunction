...
execute unless data storage randomizer: Pos unless loaded 168 90 283 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 483
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [168, 90, 283]
