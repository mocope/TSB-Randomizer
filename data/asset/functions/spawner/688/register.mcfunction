...
execute unless data storage randomizer: Pos unless loaded -166 170 -328 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 688
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-166, 170, -328]
