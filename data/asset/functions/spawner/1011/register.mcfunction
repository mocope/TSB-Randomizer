...
execute unless data storage randomizer: Pos unless loaded -447 94 88 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1011
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-447, 94, 88]
