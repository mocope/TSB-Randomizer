...
execute unless data storage randomizer: Pos unless loaded -187 204 614 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 608
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-187, 204, 614]
