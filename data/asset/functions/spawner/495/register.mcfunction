...
execute unless data storage randomizer: Pos unless loaded 11 60 368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 495
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [11, 60, 368]
