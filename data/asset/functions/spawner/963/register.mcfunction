...
execute unless data storage randomizer: Pos unless loaded 62 176 -471 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 963
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [62, 176, -471]
