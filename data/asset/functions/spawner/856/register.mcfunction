...
execute unless data storage randomizer: Pos unless loaded 54 129 246 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 856
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [54, 129, 246]
