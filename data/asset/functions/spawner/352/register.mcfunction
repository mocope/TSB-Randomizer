...
execute unless data storage randomizer: Pos unless loaded 92 114 -232 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 352
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [92, 114, -232]
