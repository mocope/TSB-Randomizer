...
execute unless data storage randomizer: Pos unless loaded 324 17 411 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 799
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [324, 17, 411]
