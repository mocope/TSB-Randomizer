...
execute unless data storage randomizer: Pos unless loaded 21 15 -14 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [21, 15, -14]
