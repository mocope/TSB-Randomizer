...
execute unless data storage randomizer: Pos unless loaded 74 151 -224 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 379
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [74, 151, -224]
