...
execute unless data storage randomizer: Pos unless loaded 164 165 -184 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 600
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [164, 165, -184]
