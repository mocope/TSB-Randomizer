...
execute unless data storage randomizer: Pos unless loaded -148 165 -366 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 695
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-148, 165, -366]
