...
execute unless data storage randomizer: Pos unless loaded 241 145 124 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 454
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [241, 145, 124]
