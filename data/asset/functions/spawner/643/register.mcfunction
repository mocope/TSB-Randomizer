...
execute unless data storage randomizer: Pos unless loaded -144 200 -344 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 643
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-144, 200, -344]
