...
execute unless data storage randomizer: Pos unless loaded 95 120 -245 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 350
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [95, 120, -245]
