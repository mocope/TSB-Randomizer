...
execute unless data storage randomizer: Pos unless loaded 64 19 -17 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 4
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [64, 19, -17]
