...
execute unless data storage randomizer: Pos unless loaded -99 29 8 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 35
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-99, 29, 8]
