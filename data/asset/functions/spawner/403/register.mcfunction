...
execute unless data storage randomizer: Pos unless loaded -129 87 143 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 403
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-129, 87, 143]
