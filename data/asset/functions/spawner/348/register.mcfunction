...
execute unless data storage randomizer: Pos unless loaded 83 97 -271 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 348
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [83, 97, -271]
