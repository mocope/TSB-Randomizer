...
execute unless data storage randomizer: Pos unless loaded -90 7 1 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 39
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-90, 7, 1]
