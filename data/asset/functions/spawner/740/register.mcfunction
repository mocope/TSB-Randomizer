...
execute unless data storage randomizer: Pos unless loaded -190 227 182 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 740
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-190, 227, 182]
