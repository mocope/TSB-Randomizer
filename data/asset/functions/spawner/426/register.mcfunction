...
execute unless data storage randomizer: Pos unless loaded -262 54 148 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 426
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-262, 54, 148]
