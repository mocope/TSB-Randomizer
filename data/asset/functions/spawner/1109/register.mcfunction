...
execute unless data storage randomizer: Pos unless loaded 111 184 580 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1109
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [111, 184, 580]
