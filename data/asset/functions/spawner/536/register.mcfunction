...
execute unless data storage randomizer: Pos unless loaded 407 87 55 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 536
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [407, 87, 55]
