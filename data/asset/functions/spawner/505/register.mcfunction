...
execute unless data storage randomizer: Pos unless loaded 23 76 348 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 505
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [23, 76, 348]
