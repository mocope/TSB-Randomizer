...
execute unless data storage randomizer: Pos unless loaded 425 97 57 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 528
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [425, 97, 57]
