...
execute unless data storage randomizer: Pos unless loaded -35 2 95 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 236
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-35, 2, 95]
