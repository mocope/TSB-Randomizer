...
execute unless data storage randomizer: Pos unless loaded 165 97 75 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 839
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [165, 97, 75]
