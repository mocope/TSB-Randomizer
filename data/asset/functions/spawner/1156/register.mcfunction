...
execute unless data storage randomizer: Pos unless loaded -282 295 -174 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1156
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-282, 295, -174]
