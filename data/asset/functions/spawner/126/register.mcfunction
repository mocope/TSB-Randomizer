...
execute unless data storage randomizer: Pos unless loaded 3 36 -194 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 126
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [3, 36, -194]
