...
execute unless data storage randomizer: Pos unless loaded -125 178 -312 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 682
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-125, 178, -312]
