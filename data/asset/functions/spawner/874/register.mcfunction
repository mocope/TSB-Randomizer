...
execute unless data storage randomizer: Pos unless loaded 181 146 242 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 874
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [181, 146, 242]
