...
execute unless data storage randomizer: Pos unless loaded -216 23 379 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 766
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-216, 23, 379]
