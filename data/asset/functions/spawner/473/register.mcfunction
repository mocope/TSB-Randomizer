...
execute unless data storage randomizer: Pos unless loaded 292 56 -82 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 473
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [292, 56, -82]
