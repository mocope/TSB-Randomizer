...
execute unless data storage randomizer: Pos unless loaded 45 3 107 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 97
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [45, 3, 107]
