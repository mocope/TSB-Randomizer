...
execute unless data storage randomizer: Pos unless loaded -117 34 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 117
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-117, 34, 226]
