...
execute unless data storage randomizer: Pos unless loaded -460 94 13 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1026
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-460, 94, 13]
