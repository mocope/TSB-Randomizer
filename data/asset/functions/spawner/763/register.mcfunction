...
execute unless data storage randomizer: Pos unless loaded -150 222 172 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 763
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-150, 222, 172]
