...
execute unless data storage randomizer: Pos unless loaded 282 144 124 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 458
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [282, 144, 124]
