...
execute unless data storage randomizer: Pos unless loaded 409 46 52 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 556
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [409, 46, 52]
