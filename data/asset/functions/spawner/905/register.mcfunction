...
execute unless data storage randomizer: Pos unless loaded 102 146 711 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 905
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [102, 146, 711]
