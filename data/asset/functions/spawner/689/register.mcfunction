...
execute unless data storage randomizer: Pos unless loaded -149 165 -328 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 689
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-149, 165, -328]
