...
execute unless data storage randomizer: Pos unless loaded -473 85 90 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1008
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-473, 85, 90]
