...
execute unless data storage randomizer: Pos unless loaded 74 158 -504 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 980
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [74, 158, -504]
