...
execute unless data storage randomizer: Pos unless loaded 362 19 405 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 802
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [362, 19, 405]
