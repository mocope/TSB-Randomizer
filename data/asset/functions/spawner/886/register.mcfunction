...
execute unless data storage randomizer: Pos unless loaded 92 157 343 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 886
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [92, 157, 343]
