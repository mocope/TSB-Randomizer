...
execute unless data storage randomizer: Pos unless loaded -35 2 99 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 238
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-35, 2, 99]
