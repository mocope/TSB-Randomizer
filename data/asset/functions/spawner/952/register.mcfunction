...
execute unless data storage randomizer: Pos unless loaded 191 155 -368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 952
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [191, 155, -368]
