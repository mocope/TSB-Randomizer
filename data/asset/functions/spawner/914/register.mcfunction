...
execute unless data storage randomizer: Pos unless loaded 173 91 1929 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 914
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [173, 91, 1929]
