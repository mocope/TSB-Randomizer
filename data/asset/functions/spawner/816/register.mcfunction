...
execute unless data storage randomizer: Pos unless loaded 300 17 385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 816
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [300, 17, 385]
