...
execute unless data storage randomizer: Pos unless loaded -481 113 83 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1035
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-481, 113, 83]
