...
execute unless data storage randomizer: Pos unless loaded -175 169 -349 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 685
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-175, 169, -349]
