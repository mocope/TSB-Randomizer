...
execute unless data storage randomizer: Pos unless loaded 163 12 -77 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 75
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [163, 12, -77]
