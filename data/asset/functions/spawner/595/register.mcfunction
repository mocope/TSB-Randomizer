...
execute unless data storage randomizer: Pos unless loaded 174 155 -167 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 595
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [174, 155, -167]
