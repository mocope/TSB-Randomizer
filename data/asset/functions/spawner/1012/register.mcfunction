...
execute unless data storage randomizer: Pos unless loaded -468 95 79 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1012
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-468, 95, 79]
