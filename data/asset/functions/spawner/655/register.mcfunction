...
execute unless data storage randomizer: Pos unless loaded -118 195 -328 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 655
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-118, 195, -328]
