...
execute unless data storage randomizer: Pos unless loaded -76 156 186 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 437
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-76, 156, 186]
