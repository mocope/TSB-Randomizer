...
execute unless data storage randomizer: Pos unless loaded 416 82 59 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 537
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [416, 82, 59]
