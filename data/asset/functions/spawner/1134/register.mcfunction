...
execute unless data storage randomizer: Pos unless loaded 257 106 -272 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1134
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [257, 106, -272]
