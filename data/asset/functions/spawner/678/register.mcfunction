...
execute unless data storage randomizer: Pos unless loaded -162 178 -386 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 678
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-162, 178, -386]
