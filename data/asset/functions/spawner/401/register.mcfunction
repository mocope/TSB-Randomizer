...
execute unless data storage randomizer: Pos unless loaded -153 111 -231 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 401
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-153, 111, -231]
