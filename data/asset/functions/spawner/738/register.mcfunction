...
execute unless data storage randomizer: Pos unless loaded -172 240 199 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 738
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-172, 240, 199]
