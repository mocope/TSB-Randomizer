...
execute unless data storage randomizer: Pos unless loaded -133 199 -392 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 658
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-133, 199, -392]
