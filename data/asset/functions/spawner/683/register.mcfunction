...
execute unless data storage randomizer: Pos unless loaded -190 165 -347 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 683
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-190, 165, -347]
