...
execute unless data storage randomizer: Pos unless loaded -168 187 215 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 760
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-168, 187, 215]
