...
execute unless data storage randomizer: Pos unless loaded -6 74 335 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 509
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-6, 74, 335]
