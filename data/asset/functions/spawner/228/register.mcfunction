...
execute unless data storage randomizer: Pos unless loaded -149 47 62 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 228
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-149, 47, 62]
