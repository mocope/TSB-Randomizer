...
execute unless data storage randomizer: Pos unless loaded 255 74 -238 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 335
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [255, 74, -238]
