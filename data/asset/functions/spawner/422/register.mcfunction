...
execute unless data storage randomizer: Pos unless loaded -277 67 166 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 422
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-277, 67, 166]
