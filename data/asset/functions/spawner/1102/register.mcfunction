...
execute unless data storage randomizer: Pos unless loaded 127 88 563 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1102
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [127, 88, 563]
