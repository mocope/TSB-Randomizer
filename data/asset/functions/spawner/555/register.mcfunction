...
execute unless data storage randomizer: Pos unless loaded 425 45 76 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 555
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [425, 45, 76]
