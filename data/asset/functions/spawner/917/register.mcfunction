...
execute unless data storage randomizer: Pos unless loaded 128 91 1963 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 917
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [128, 91, 1963]
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [84,416,181,265]
# 一度に召喚する数 (int)
