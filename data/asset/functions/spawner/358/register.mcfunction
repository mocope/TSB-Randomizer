...
execute unless data storage randomizer: Pos unless loaded 62 94 -265 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 358
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [62, 94, -265]
