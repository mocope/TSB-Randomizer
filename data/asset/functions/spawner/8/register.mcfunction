...
execute unless data storage randomizer: Pos unless loaded 23 5 52 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 8
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [23, 5, 52]
