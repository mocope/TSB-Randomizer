...
execute unless data storage randomizer: Pos unless loaded 215 8 111 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 212
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [215, 8, 111]
