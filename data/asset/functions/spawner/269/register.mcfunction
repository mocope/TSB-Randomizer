...
execute unless data storage randomizer: Pos unless loaded -50 70 -270 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 269
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-50, 70, -270]
