...
execute unless data storage randomizer: Pos unless loaded -203 210 -333 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 638
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-203, 210, -333]
