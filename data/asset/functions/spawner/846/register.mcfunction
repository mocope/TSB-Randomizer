...
execute unless data storage randomizer: Pos unless loaded 101 133 162 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 846
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [101, 133, 162]
