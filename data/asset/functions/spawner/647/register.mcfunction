...
execute unless data storage randomizer: Pos unless loaded -179 193 -328 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 647
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-179, 193, -328]
