...
execute unless data storage randomizer: Pos unless loaded 191 5 -142 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 172
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [191, 5, -142]
