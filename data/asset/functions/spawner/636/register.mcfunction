...
execute unless data storage randomizer: Pos unless loaded -178 210 -381 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 636
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-178, 210, -381]
