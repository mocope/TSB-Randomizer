...
execute unless data storage randomizer: Pos unless loaded 184 165 -184 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 599
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [184, 165, -184]
