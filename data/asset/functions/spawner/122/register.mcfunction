...
execute unless data storage randomizer: Pos unless loaded -96 41 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 122
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-96, 41, 226]
