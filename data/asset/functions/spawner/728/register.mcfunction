...
execute unless data storage randomizer: Pos unless loaded 24 85 -386 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 728
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [24, 85, -386]
