...
execute unless data storage randomizer: Pos unless loaded -20 5 40 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 92
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-20, 5, 40]
