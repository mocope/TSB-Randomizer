...
execute unless data storage randomizer: Pos unless loaded 51 161 237 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 862
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [51, 161, 237]
