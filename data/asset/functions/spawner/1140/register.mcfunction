...
execute unless data storage randomizer: Pos unless loaded 275 106 -272 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1140
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [275, 106, -272]
