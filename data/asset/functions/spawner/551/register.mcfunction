...
execute unless data storage randomizer: Pos unless loaded 405 36 111 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 551
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [405, 36, 111]
