...
execute unless data storage randomizer: Pos unless loaded -477 85 39 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1021
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-477, 85, 39]
