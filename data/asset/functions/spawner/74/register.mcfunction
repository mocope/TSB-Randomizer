...
execute unless data storage randomizer: Pos unless loaded 152 12 -56 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 74
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [152, 12, -56]
