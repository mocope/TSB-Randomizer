...
execute unless data storage randomizer: Pos unless loaded -147 210 -320 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 631
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-147, 210, -320]
