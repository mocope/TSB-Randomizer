...
execute unless data storage randomizer: Pos unless loaded -474 76 19 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1020
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-474, 76, 19]
