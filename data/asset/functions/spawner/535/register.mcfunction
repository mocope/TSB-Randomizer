...
execute unless data storage randomizer: Pos unless loaded 407 87 75 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 535
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [407, 87, 75]
