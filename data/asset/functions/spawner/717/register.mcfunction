...
execute unless data storage randomizer: Pos unless loaded -278 241 -178 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 717
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-278, 241, -178]
