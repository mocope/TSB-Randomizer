...
execute unless data storage randomizer: Pos unless loaded 119 149 484 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 895
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [119, 149, 484]
