...
execute unless data storage randomizer: Pos unless loaded 94 116 196 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 850
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [94, 116, 196]
