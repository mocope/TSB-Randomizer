...
execute unless data storage randomizer: Pos unless loaded 299 17 431 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 815
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [299, 17, 431]
