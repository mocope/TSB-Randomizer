...
execute unless data storage randomizer: Pos unless loaded 30 -10 95 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 104
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [30, -10, 95]
