...
execute unless data storage randomizer: Pos unless loaded 20 68 -389 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 724
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [20, 68, -389]
