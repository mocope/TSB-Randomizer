...
execute unless data storage randomizer: Pos unless loaded 116 73 555 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1097
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [116, 73, 555]
