...
execute unless data storage randomizer: Pos unless loaded 435 46 112 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 554
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [435, 46, 112]
