...
execute unless data storage randomizer: Pos unless loaded 45 160 252 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 864
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [45, 160, 252]
