...
execute unless data storage randomizer: Pos unless loaded -58 161 396 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 305
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-58, 161, 396]
