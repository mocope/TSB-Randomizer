...
execute unless data storage randomizer: Pos unless loaded 396 8 97 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 540
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [396, 8, 97]
