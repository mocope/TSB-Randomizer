...
execute unless data storage randomizer: Pos unless loaded -129 186 183 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 759
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-129, 186, 183]
