...
execute unless data storage randomizer: Pos unless loaded -437 85 84 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1006
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-437, 85, 84]
