...
execute unless data storage randomizer: Pos unless loaded -73 50 397 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 325
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-73, 50, 397]
