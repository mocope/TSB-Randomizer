...
execute unless data storage randomizer: Pos unless loaded 411 6 129 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 541
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [411, 6, 129]
