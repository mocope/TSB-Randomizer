...
execute unless data storage randomizer: Pos unless loaded 144 40 -181 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 139
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [144, 40, -181]
