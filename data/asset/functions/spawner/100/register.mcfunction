...
execute unless data storage randomizer: Pos unless loaded 29 12 94 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 100
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [29, 12, 94]
