...
execute unless data storage randomizer: Pos unless loaded -178 194 194 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 752
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-178, 194, 194]
