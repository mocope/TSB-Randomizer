...
execute unless data storage randomizer: Pos unless loaded 448 18 60 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 544
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [448, 18, 60]
