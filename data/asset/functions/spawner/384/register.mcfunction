...
execute unless data storage randomizer: Pos unless loaded 74 151 -240 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 384
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [74, 151, -240]
