...
execute unless data storage randomizer: Pos unless loaded -260 65 184 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 424
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-260, 65, 184]
