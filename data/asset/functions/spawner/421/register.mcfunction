...
execute unless data storage randomizer: Pos unless loaded -297 70 155 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 421
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-297, 70, 155]
