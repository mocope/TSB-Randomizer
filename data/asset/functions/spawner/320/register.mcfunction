...
execute unless data storage randomizer: Pos unless loaded -57 70 388 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 320
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-57, 70, 388]
