...
execute unless data storage randomizer: Pos unless loaded -71 7 51 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 27
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-71, 7, 51]
