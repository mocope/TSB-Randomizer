...
execute unless data storage randomizer: Pos unless loaded 46 48 362 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 492
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [46, 48, 362]
