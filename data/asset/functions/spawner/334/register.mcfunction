...
execute unless data storage randomizer: Pos unless loaded 271 110 -248 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 334
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [271, 110, -248]
