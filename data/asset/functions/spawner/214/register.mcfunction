...
execute unless data storage randomizer: Pos unless loaded 206 7 130 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 214
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [206, 7, 130]
