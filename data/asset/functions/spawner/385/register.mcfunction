...
execute unless data storage randomizer: Pos unless loaded 89 150 -240 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 385
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [89, 150, -240]
