...
execute unless data storage randomizer: Pos unless loaded 367 16 385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 811
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [367, 16, 385]
