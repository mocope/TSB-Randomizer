...
execute unless data storage randomizer: Pos unless loaded 192 12 -81 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 79
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [192, 12, -81]
