...
execute unless data storage randomizer: Pos unless loaded 53 74 350 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 506
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [53, 74, 350]
