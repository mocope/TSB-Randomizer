...
execute unless data storage randomizer: Pos unless loaded 292 42 -81 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 472
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [292, 42, -81]
