...
execute unless data storage randomizer: Pos unless loaded 462 213 -145 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 589
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [462, 213, -145]
