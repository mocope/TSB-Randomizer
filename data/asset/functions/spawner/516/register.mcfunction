...
execute unless data storage randomizer: Pos unless loaded -125 37 -32 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 516
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-125, 37, -32]
