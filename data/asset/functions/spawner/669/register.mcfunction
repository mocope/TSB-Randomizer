...
execute unless data storage randomizer: Pos unless loaded -132 183 -351 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 669
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-132, 183, -351]
