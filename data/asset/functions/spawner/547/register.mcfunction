...
execute unless data storage randomizer: Pos unless loaded 405 21 32 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 547
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [405, 21, 32]
