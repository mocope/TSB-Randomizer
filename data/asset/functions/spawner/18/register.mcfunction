...
execute unless data storage randomizer: Pos unless loaded 109 12 45 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 18
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [109, 12, 45]
