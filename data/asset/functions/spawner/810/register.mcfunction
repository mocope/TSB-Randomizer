...
execute unless data storage randomizer: Pos unless loaded 464 5 408 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 810
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [464, 5, 408]
