...
execute unless data storage randomizer: Pos unless loaded 12 49 -394 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 719
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [12, 49, -394]
