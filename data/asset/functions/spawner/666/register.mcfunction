...
execute unless data storage randomizer: Pos unless loaded -147 178 -365 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 666
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-147, 178, -365]
