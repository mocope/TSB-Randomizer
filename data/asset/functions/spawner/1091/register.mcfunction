...
execute unless data storage randomizer: Pos unless loaded 107 32 604 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1091
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [107, 32, 604]
