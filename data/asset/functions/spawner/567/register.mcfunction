...
execute unless data storage randomizer: Pos unless loaded 462 175 -152 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 567
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [462, 175, -152]
