...
execute unless data storage randomizer: Pos unless loaded 72 176 -485 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 964
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [72, 176, -485]
