...
execute unless data storage randomizer: Pos unless loaded -132 169 -356 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 693
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-132, 169, -356]
