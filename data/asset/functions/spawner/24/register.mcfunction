...
execute unless data storage randomizer: Pos unless loaded -63 19 49 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 24
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-63, 19, 49]
