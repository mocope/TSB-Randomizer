...
execute unless data storage randomizer: Pos unless loaded 79 158 -224 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 380
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [79, 158, -224]
