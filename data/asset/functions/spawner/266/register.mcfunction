...
execute unless data storage randomizer: Pos unless loaded -70 69 -277 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 266
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-70, 69, -277]
