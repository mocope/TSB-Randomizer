...
execute unless data storage randomizer: Pos unless loaded 384 22 408 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 804
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [384, 22, 408]
