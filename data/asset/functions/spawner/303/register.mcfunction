...
execute unless data storage randomizer: Pos unless loaded -62 171 383 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 303
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-62, 171, 383]
