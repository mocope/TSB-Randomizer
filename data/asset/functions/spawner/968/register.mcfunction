...
execute unless data storage randomizer: Pos unless loaded 142 188 -477 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 968
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [142, 188, -477]
