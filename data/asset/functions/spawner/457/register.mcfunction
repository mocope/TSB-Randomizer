...
execute unless data storage randomizer: Pos unless loaded 253 140 125 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 457
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [253, 140, 125]
