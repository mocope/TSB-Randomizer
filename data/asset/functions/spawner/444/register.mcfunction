...
execute unless data storage randomizer: Pos unless loaded 286 44 254 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 444
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [286, 44, 254]
