...
execute unless data storage randomizer: Pos unless loaded -451 143 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1048
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-451, 143, 58]
