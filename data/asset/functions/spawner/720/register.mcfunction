...
execute unless data storage randomizer: Pos unless loaded 37 49 -367 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 720
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [37, 49, -367]
