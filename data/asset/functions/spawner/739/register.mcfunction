...
execute unless data storage randomizer: Pos unless loaded -190 235 183 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 739
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-190, 235, 183]
