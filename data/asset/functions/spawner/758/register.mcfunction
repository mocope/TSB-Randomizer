...
execute unless data storage randomizer: Pos unless loaded -147 187 189 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 758
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-147, 187, 189]
