...
execute unless data storage randomizer: Pos unless loaded -136 181 -376 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 668
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-136, 181, -376]
