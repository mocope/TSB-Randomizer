...
execute unless data storage randomizer: Pos unless loaded 298 5 385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 817
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [298, 5, 385]
