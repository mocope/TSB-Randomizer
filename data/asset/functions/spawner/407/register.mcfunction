...
execute unless data storage randomizer: Pos unless loaded -148 82 152 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 407
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-148, 82, 152]
