...
execute unless data storage randomizer: Pos unless loaded 454 194 -153 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 581
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [454, 194, -153]
