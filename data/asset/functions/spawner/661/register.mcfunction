...
execute unless data storage randomizer: Pos unless loaded -201 193 -363 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 661
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-201, 193, -363]
