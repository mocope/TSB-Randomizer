...
execute unless data storage randomizer: Pos unless loaded -244 86 197 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 411
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-244, 86, 197]
