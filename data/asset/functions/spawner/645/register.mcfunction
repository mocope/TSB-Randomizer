...
execute unless data storage randomizer: Pos unless loaded -160 198 -345 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 645
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-160, 198, -345]
