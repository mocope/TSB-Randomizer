...
execute unless data storage randomizer: Pos unless loaded 99 95 -260 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 363
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [99, 95, -260]
