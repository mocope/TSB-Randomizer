...
execute unless data storage randomizer: Pos unless loaded 138 97 591 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1103
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [138, 97, 591]
