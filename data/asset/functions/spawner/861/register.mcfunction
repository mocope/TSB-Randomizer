...
execute unless data storage randomizer: Pos unless loaded 41 154 231 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 861
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [41, 154, 231]
