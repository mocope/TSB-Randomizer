...
execute unless data storage randomizer: Pos unless loaded 432 16 52 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 545
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [432, 16, 52]
