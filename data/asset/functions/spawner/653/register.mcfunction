...
execute unless data storage randomizer: Pos unless loaded -194 197 -315 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 653
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-194, 197, -315]
