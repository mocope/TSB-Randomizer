...
execute unless data storage randomizer: Pos unless loaded -431 131 33 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1043
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-431, 131, 33]
