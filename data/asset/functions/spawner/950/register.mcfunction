...
execute unless data storage randomizer: Pos unless loaded 152 155 -388 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 950
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [152, 155, -388]
