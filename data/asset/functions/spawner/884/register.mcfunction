...
execute unless data storage randomizer: Pos unless loaded 81 163 333 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 884
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [81, 163, 333]
