...
execute unless data storage randomizer: Pos unless loaded -455 85 80 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1007
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-455, 85, 80]
