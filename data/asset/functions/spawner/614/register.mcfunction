...
execute unless data storage randomizer: Pos unless loaded -202 235 652 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 614
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-202, 235, 652]
