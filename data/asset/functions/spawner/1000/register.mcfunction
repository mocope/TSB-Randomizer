...
execute unless data storage randomizer: Pos unless loaded -424 67 79 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1000
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-424, 67, 79]
