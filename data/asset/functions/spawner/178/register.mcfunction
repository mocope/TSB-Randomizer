...
execute unless data storage randomizer: Pos unless loaded -21 2 162 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 178
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-21, 2, 162]
