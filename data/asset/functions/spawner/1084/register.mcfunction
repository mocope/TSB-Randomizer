...
execute unless data storage randomizer: Pos unless loaded 78 19 642 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1084
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [78, 19, 642]
