...
execute unless data storage randomizer: Pos unless loaded -199 178 -312 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 681
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-199, 178, -312]
