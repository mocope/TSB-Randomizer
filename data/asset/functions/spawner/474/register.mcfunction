...
execute unless data storage randomizer: Pos unless loaded 292 52 -82 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 474
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [292, 52, -82]
