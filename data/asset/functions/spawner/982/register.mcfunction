...
execute unless data storage randomizer: Pos unless loaded 60 150 -556 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 982
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [60, 150, -556]
