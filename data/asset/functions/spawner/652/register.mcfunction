...
execute unless data storage randomizer: Pos unless loaded -178 193 -303 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 652
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-178, 193, -303]
