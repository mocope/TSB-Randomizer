...
execute unless data storage randomizer: Pos unless loaded -150 90 143 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 409
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-150, 90, 143]
