...
execute unless data storage randomizer: Pos unless loaded 66 127 229 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 855
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [66, 127, 229]
