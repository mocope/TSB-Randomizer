...
execute unless data storage randomizer: Pos unless loaded 131 98 97 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 835
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [131, 98, 97]
