...
execute unless data storage randomizer: Pos unless loaded -491 95 79 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1013
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-491, 95, 79]
