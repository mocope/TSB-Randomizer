...
execute unless data storage randomizer: Pos unless loaded 414 66 34 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 557
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [414, 66, 34]
