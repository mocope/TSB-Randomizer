...
execute unless data storage randomizer: Pos unless loaded -106 41 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 118
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-106, 41, 226]
