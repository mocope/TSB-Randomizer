...
execute unless data storage randomizer: Pos unless loaded 26 -7 91 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 107
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [26, -7, 91]
