...
execute unless data storage randomizer: Pos unless loaded 43 66 368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 498
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [43, 66, 368]
