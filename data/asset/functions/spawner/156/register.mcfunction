...
execute unless data storage randomizer: Pos unless loaded -84 -16 144 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 156
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-84, -16, 144]
