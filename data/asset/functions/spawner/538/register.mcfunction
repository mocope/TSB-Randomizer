...
execute unless data storage randomizer: Pos unless loaded 425 77 55 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 538
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [425, 77, 55]
