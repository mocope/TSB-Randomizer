...
execute unless data storage randomizer: Pos unless loaded 301 32 -80 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 460
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [301, 32, -80]
