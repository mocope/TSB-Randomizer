...
execute unless data storage randomizer: Pos unless loaded 305 72 -216 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 338
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [305, 72, -216]
