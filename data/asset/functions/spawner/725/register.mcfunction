...
execute unless data storage randomizer: Pos unless loaded 14 68 -380 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 725
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [14, 68, -380]
