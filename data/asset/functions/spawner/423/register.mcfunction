...
execute unless data storage randomizer: Pos unless loaded -276 68 193 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 423
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-276, 68, 193]
