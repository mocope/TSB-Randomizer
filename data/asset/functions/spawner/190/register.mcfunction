...
execute unless data storage randomizer: Pos unless loaded 55 12 215 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 190
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [55, 12, 215]
