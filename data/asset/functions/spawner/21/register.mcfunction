...
execute unless data storage randomizer: Pos unless loaded 121 5 44 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 21
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [121, 5, 44]
