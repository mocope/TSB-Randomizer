...
execute unless data storage randomizer: Pos unless loaded 59 96 -234 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 359
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [59, 96, -234]
