...
execute unless data storage randomizer: Pos unless loaded -265 41 166 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 427
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-265, 41, 166]
