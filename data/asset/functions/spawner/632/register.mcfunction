...
execute unless data storage randomizer: Pos unless loaded -123 210 -335 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 632
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-123, 210, -335]
