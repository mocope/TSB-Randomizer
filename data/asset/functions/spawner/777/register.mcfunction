...
execute unless data storage randomizer: Pos unless loaded -203 51 411 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 777
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-203, 51, 411]
