...
execute unless data storage randomizer: Pos unless loaded 337 24 408 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 800
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [337, 24, 408]
