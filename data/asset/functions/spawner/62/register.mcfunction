...
execute unless data storage randomizer: Pos unless loaded 50 20 -110 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 62
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [50, 20, -110]
