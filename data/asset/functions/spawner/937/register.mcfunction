...
execute unless data storage randomizer: Pos unless loaded 172 129 -360 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 937
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [172, 129, -360]
