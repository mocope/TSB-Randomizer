...
execute unless data storage randomizer: Pos unless loaded 68 126 -218 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 370
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [68, 126, -218]
