...
execute unless data storage randomizer: Pos unless loaded 24 41 -380 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 718
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [24, 41, -380]
