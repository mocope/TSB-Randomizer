...
execute unless data storage randomizer: Pos unless loaded -156 178 -319 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 672
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-156, 178, -319]
