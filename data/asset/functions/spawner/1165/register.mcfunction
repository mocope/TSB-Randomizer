...
execute unless data storage randomizer: Pos unless loaded 78 107 1939 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1165
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [78, 107, 1939]
