...
execute unless data storage randomizer: Pos unless loaded 136 176 -469 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 960
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [136, 176, -469]
