...
execute unless data storage randomizer: Pos unless loaded 306 18 408 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 796
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [306, 18, 408]
