...
execute unless data storage randomizer: Pos unless loaded -130 210 -388 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 634
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-130, 210, -388]
