...
execute unless data storage randomizer: Pos unless loaded 469 201 -153 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 583
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [469, 201, -153]
