...
execute unless data storage randomizer: Pos unless loaded 96 150 -575 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 984
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [96, 150, -575]
