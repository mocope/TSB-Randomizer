...
execute unless data storage randomizer: Pos unless loaded 110 171 -569 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1068
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [110, 171, -569]
