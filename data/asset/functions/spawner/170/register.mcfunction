...
execute unless data storage randomizer: Pos unless loaded 184 6 -122 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 170
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [184, 6, -122]
