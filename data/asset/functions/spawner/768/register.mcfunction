...
execute unless data storage randomizer: Pos unless loaded -204 35 411 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 768
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-204, 35, 411]
