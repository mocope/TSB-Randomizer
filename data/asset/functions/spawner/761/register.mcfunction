...
execute unless data storage randomizer: Pos unless loaded -171 184 231 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 761
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-171, 184, 231]
