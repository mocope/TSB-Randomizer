...
execute unless data storage randomizer: Pos unless loaded -71 7 47 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 28
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-71, 7, 47]
