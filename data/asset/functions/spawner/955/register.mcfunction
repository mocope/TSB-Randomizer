...
execute unless data storage randomizer: Pos unless loaded 194 113 -364 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 955
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [194, 113, -364]
