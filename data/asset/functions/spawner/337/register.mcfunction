...
execute unless data storage randomizer: Pos unless loaded 229 72 -221 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 337
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [229, 72, -221]
