...
execute unless data storage randomizer: Pos unless loaded 129 116 1953 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 925
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [129, 116, 1953]
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [159,189,423,150]
# 一度に召喚する数 (int)
