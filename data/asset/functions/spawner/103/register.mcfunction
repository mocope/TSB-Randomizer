...
execute unless data storage randomizer: Pos unless loaded 39 -10 99 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 103
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [39, -10, 99]
