...
execute unless data storage randomizer: Pos unless loaded 57 7 -127 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 64
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [57, 7, -127]
