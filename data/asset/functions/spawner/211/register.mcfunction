...
execute unless data storage randomizer: Pos unless loaded 186 3 126 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 211
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [186, 3, 126]
