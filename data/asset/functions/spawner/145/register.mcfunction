...
execute unless data storage randomizer: Pos unless loaded 145 80 30 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 145
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [145, 80, 30]
