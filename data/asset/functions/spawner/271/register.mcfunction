...
execute unless data storage randomizer: Pos unless loaded -57 52 -289 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 271
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-57, 52, -289]
