...
execute unless data storage randomizer: Pos unless loaded 232 43 228 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 442
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [232, 43, 228]
