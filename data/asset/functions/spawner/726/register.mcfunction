...
execute unless data storage randomizer: Pos unless loaded 32 68 -380 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 726
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [32, 68, -380]
