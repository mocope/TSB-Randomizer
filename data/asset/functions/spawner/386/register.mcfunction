...
execute unless data storage randomizer: Pos unless loaded 91 151 -224 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 386
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [91, 151, -224]
