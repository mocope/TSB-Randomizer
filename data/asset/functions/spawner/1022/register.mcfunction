...
execute unless data storage randomizer: Pos unless loaded -492 85 48 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1022
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-492, 85, 48]
