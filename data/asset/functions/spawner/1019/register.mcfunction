...
execute unless data storage randomizer: Pos unless loaded -472 76 41 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1019
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-472, 76, 41]
