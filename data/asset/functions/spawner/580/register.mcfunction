...
execute unless data storage randomizer: Pos unless loaded 470 194 -153 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 580
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [470, 194, -153]
