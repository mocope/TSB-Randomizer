...
execute unless data storage randomizer: Pos unless loaded 91 21 -113 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 69
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [91, 21, -113]
