...
execute unless data storage randomizer: Pos unless loaded -149 49 -107 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 246
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-149, 49, -107]
