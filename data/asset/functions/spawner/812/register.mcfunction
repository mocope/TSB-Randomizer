...
execute unless data storage randomizer: Pos unless loaded 366 16 431 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 812
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [366, 16, 431]
