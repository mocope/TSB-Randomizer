...
execute unless data storage randomizer: Pos unless loaded 129 49 -178 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 138
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [129, 49, -178]
