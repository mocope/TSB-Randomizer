...
execute unless data storage randomizer: Pos unless loaded 192 139 -363 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 946
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [192, 139, -363]
