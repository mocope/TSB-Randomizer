...
execute unless data storage randomizer: Pos unless loaded 166 126 254 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 867
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [166, 126, 254]
