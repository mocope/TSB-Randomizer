...
execute unless data storage randomizer: Pos unless loaded 185 112 -337 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 931
# Pos ([int] @ 3)
