...
execute unless data storage randomizer: Pos unless loaded -2 66 362 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 497
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-2, 66, 362]
