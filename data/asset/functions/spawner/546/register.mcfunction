...
execute unless data storage randomizer: Pos unless loaded 415 16 80 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 546
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [415, 16, 80]
