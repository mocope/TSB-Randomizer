...
execute unless data storage randomizer: Pos unless loaded 258 44 282 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 445
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [258, 44, 282]
