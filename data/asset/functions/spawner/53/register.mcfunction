...
execute unless data storage randomizer: Pos unless loaded -35 29 -133 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 53
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-35, 29, -133]
