...
execute unless data storage randomizer: Pos unless loaded 22 117 -381 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1123
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [22, 117, -381]
