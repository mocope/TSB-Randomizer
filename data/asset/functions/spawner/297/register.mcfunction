...
execute unless data storage randomizer: Pos unless loaded -64 201 383 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 297
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-64, 201, 383]
