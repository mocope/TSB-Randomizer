...
execute unless data storage randomizer: Pos unless loaded -489 76 27 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1018
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-489, 76, 27]
