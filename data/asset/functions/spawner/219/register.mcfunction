...
execute unless data storage randomizer: Pos unless loaded 149 9 187 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 219
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [149, 9, 187]
