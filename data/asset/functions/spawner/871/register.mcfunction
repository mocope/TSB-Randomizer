...
execute unless data storage randomizer: Pos unless loaded 196 143 230 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 871
# Pos ([int] @ 3)
