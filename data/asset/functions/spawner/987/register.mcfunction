...
execute unless data storage randomizer: Pos unless loaded 123 147 -532 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 987
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [123, 147, -532]
