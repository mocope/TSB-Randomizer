...
execute unless data storage randomizer: Pos unless loaded 272 106 -275 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1145
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [272, 106, -275]
