...
execute unless data storage randomizer: Pos unless loaded 139 85 85 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 830
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [139, 85, 85]
