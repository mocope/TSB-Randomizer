...
execute unless data storage randomizer: Pos unless loaded -76 61 385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 322
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-76, 61, 385]
