...
execute unless data storage randomizer: Pos unless loaded -188 178 -378 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 677
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-188, 178, -378]
