...
execute unless data storage randomizer: Pos unless loaded 42 134 209 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 859
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [42, 134, 209]
