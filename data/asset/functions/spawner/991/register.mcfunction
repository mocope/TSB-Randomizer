...
execute unless data storage randomizer: Pos unless loaded 72 141 -498 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 991
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [72, 141, -498]
