...
execute unless data storage randomizer: Pos unless loaded -201 199 -385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 660
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-201, 199, -385]
