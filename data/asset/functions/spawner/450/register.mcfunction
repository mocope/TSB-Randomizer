...
execute unless data storage randomizer: Pos unless loaded 246 54 266 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 450
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [246, 54, 266]
