...
execute unless data storage randomizer: Pos unless loaded -293 131 -207 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 708
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-293, 131, -207]
