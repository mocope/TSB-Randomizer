...
execute unless data storage randomizer: Pos unless loaded 120 96 -272 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 362
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [120, 96, -272]
