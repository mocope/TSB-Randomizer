...
execute unless data storage randomizer: Pos unless loaded -260 82 198 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 412
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-260, 82, 198]
