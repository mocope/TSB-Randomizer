...
execute unless data storage randomizer: Pos unless loaded -493 104 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1065
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-493, 104, 58]
