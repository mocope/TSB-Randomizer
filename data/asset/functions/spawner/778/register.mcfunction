...
execute unless data storage randomizer: Pos unless loaded -185 59 393 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 778
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-185, 59, 393]
