...
execute unless data storage randomizer: Pos unless loaded 37 70 73 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 820
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [37, 70, 73]
