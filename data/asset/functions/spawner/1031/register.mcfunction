...
execute unless data storage randomizer: Pos unless loaded -442 104 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1031
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-442, 104, 58]
