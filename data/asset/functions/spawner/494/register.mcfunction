...
execute unless data storage randomizer: Pos unless loaded 8 54 368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 494
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [8, 54, 368]
