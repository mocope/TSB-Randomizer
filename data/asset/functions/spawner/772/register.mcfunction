...
execute unless data storage randomizer: Pos unless loaded -217 15 406 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 772
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-217, 15, 406]
