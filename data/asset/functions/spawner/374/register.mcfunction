...
execute unless data storage randomizer: Pos unless loaded 61 132 -232 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 374
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [61, 132, -232]
