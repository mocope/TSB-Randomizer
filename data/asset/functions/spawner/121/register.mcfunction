...
execute unless data storage randomizer: Pos unless loaded -97 31 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 121
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-97, 31, 226]
