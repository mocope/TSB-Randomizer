...
execute unless data storage randomizer: Pos unless loaded -1 48 362 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 491
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-1, 48, 362]
