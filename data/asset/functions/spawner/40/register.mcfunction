...
execute unless data storage randomizer: Pos unless loaded -79 9 14 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 40
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-79, 9, 14]
