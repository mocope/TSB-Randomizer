...
execute unless data storage randomizer: Pos unless loaded 299 25 385 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 813
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [299, 25, 385]
