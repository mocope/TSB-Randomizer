...
execute unless data storage randomizer: Pos unless loaded 212 117 -50 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 284
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [212, 117, -50]
