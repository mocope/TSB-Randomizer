...
execute unless data storage randomizer: Pos unless loaded 150 144 -388 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 949
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [150, 144, -388]
