...
execute unless data storage randomizer: Pos unless loaded -67 31 380 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 328
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-67, 31, 380]
