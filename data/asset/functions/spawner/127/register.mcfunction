...
execute unless data storage randomizer: Pos unless loaded -3 37 -208 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 127
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-3, 37, -208]
