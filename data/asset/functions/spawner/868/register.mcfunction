...
execute unless data storage randomizer: Pos unless loaded 193 132 256 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 868
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [193, 132, 256]
