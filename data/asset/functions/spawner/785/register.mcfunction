...
execute unless data storage randomizer: Pos unless loaded -202 92 393 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 785
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-202, 92, 393]
