...
execute unless data storage randomizer: Pos unless loaded 98 120 -220 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 367
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [98, 120, -220]
