...
execute unless data storage randomizer: Pos unless loaded -62 50 -300 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 272
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-62, 50, -300]
