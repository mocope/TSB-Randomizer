...
execute unless data storage randomizer: Pos unless loaded 202 129 -374 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 939
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [202, 129, -374]
