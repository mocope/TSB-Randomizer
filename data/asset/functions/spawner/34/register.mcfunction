...
execute unless data storage randomizer: Pos unless loaded -83 35 7 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 34
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-83, 35, 7]
