...
execute unless data storage randomizer: Pos unless loaded 36 54 368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 493
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [36, 54, 368]
