...
execute unless data storage randomizer: Pos unless loaded 49 73 64 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 819
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [49, 73, 64]
