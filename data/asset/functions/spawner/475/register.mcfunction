...
execute unless data storage randomizer: Pos unless loaded 151 108 278 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 475
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [151, 108, 278]
