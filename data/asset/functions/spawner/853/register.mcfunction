...
execute unless data storage randomizer: Pos unless loaded 110 146 184 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 853
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [110, 146, 184]
