...
execute unless data storage randomizer: Pos unless loaded -85 87 -49 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 163
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-85, 87, -49]
