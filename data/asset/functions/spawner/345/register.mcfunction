...
execute unless data storage randomizer: Pos unless loaded 87 96 -223 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 345
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [87, 96, -223]
