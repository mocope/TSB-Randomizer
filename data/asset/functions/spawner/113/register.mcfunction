...
execute unless data storage randomizer: Pos unless loaded -75 68 226 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 113
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-75, 68, 226]
