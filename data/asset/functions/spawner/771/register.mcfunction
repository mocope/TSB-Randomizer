...
execute unless data storage randomizer: Pos unless loaded -221 59 393 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 771
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-221, 59, 393]
