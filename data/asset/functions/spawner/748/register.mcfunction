...
execute unless data storage randomizer: Pos unless loaded -154 205 187 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 748
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-154, 205, 187]
