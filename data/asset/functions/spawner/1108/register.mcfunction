...
execute unless data storage randomizer: Pos unless loaded 96 177 586 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1108
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [96, 177, 586]
