...
execute unless data storage randomizer: Pos unless loaded 23 119 -393 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1121
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [23, 119, -393]
