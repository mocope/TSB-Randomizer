...
execute unless data storage randomizer: Pos unless loaded 82 88 -232 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 357
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [82, 88, -232]
