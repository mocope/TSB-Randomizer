...
execute unless data storage randomizer: Pos unless loaded 92 187 333 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 880
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [92, 187, 333]
