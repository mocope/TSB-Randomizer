...
execute unless data storage randomizer: Pos unless loaded -270 47 175 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 425
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-270, 47, 175]
