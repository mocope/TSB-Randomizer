...
execute unless data storage randomizer: Pos unless loaded 27 68 -370 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 723
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [27, 68, -370]
