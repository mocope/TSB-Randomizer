...
execute unless data storage randomizer: Pos unless loaded 170 100 258 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 478
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [170, 100, 258]
