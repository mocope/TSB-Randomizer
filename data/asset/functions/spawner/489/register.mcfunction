...
execute unless data storage randomizer: Pos unless loaded 34 48 368 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 489
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [34, 48, 368]
