...
execute unless data storage randomizer: Pos unless loaded 68 137 -218 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 377
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [68, 137, -218]
