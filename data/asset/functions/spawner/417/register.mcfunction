...
execute unless data storage randomizer: Pos unless loaded -263 53 165 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 417
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-263, 53, 165]
