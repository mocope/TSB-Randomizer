...
execute unless data storage randomizer: Pos unless loaded 403 30 65 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 549
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [403, 30, 65]
