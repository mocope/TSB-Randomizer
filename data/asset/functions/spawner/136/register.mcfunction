...
execute unless data storage randomizer: Pos unless loaded 11 23 -224 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 136
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [11, 23, -224]
