...
execute unless data storage randomizer: Pos unless loaded 157 79 106 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 834
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [157, 79, 106]
