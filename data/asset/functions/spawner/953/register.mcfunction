...
execute unless data storage randomizer: Pos unless loaded 176 132 -377 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 953
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [176, 132, -377]
