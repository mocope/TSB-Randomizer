...
execute unless data storage randomizer: Pos unless loaded -154 210 -387 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 635
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-154, 210, -387]
