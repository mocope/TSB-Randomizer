...
execute unless data storage randomizer: Pos unless loaded -151 240 176 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 737
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-151, 240, 176]
