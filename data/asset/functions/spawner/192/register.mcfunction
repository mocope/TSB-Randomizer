...
execute unless data storage randomizer: Pos unless loaded 51 18 222 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 192
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [51, 18, 222]
