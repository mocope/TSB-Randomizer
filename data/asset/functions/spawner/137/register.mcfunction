...
execute unless data storage randomizer: Pos unless loaded 137 51 -197 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 137
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [137, 51, -197]
