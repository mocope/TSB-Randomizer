...
execute unless data storage randomizer: Pos unless loaded -153 88 -127 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 256
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-153, 88, -127]
