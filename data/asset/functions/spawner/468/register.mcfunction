...
execute unless data storage randomizer: Pos unless loaded 308 56 -74 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 468
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [308, 56, -74]
