...
execute unless data storage randomizer: Pos unless loaded 71 97 -283 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 347
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [71, 97, -283]
