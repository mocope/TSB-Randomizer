...
execute unless data storage randomizer: Pos unless loaded -422 67 37 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 998
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-422, 67, 37]
