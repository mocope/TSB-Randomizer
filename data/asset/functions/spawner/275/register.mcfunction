...
execute unless data storage randomizer: Pos unless loaded 214 134 -66 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 275
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [214, 134, -66]
