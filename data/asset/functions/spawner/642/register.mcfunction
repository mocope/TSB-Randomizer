...
execute unless data storage randomizer: Pos unless loaded -144 196 -365 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 642
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-144, 196, -365]
