...
execute unless data storage randomizer: Pos unless loaded 107 32 633 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1090
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [107, 32, 633]
