...
execute unless data storage randomizer: Pos unless loaded -419 104 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1064
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-419, 104, 58]
