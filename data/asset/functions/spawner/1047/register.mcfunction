...
execute unless data storage randomizer: Pos unless loaded -419 131 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1047
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-419, 131, 58]
