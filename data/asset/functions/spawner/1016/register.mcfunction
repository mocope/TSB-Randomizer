...
execute unless data storage randomizer: Pos unless loaded -471 67 49 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1016
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-471, 67, 49]
