...
execute unless data storage randomizer: Pos unless loaded 191 132 246 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 869
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [191, 132, 246]
