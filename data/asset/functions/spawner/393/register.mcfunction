...
execute unless data storage randomizer: Pos unless loaded -224 119 7 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 393
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-224, 119, 7]
