...
execute unless data storage randomizer: Pos unless loaded -179 200 -344 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 650
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-179, 200, -344]
