...
execute unless data storage randomizer: Pos unless loaded -151 169 -362 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 698
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-151, 169, -362]
