...
execute unless data storage randomizer: Pos unless loaded -223 232 651 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 615
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-223, 232, 651]
