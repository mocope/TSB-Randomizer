...
execute unless data storage randomizer: Pos unless loaded 445 89 -169 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 572
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [445, 89, -169]
