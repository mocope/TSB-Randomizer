...
execute unless data storage randomizer: Pos unless loaded 99 173 308 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 877
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [99, 173, 308]
