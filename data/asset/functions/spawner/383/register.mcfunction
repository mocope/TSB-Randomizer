...
execute unless data storage randomizer: Pos unless loaded 90 158 -229 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 383
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [90, 158, -229]
