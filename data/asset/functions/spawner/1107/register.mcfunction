...
execute unless data storage randomizer: Pos unless loaded 95 161 601 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1107
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [95, 161, 601]
