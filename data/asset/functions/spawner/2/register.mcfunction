...
execute unless data storage randomizer: Pos unless loaded -20 21 -39 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 2
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-20, 21, -39]
