...
execute unless data storage randomizer: Pos unless loaded 483 72 -140 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 559
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [483, 72, -140]
