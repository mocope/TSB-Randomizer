...
execute unless data storage randomizer: Pos unless loaded 167 139 -380 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 947
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [167, 139, -380]
