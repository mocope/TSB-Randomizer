...
execute unless data storage randomizer: Pos unless loaded -179 193 -356 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 646
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-179, 193, -356]
