...
execute unless data storage randomizer: Pos unless loaded 46 14 232 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 191
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [46, 14, 232]
