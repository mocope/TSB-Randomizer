...
execute unless data storage randomizer: Pos unless loaded 229 116 -41 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 281
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [229, 116, -41]
