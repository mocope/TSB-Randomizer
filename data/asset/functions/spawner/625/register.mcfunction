...
execute unless data storage randomizer: Pos unless loaded -247 205 614 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 625
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-247, 205, 614]
