...
execute unless data storage randomizer: Pos unless loaded 184 10 -29 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 77
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [184, 10, -29]
