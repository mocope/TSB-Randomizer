...
execute unless data storage randomizer: Pos unless loaded -127 210 -360 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 633
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-127, 210, -360]
