...
execute unless data storage randomizer: Pos unless loaded -472 94 13 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1027
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-472, 94, 13]
