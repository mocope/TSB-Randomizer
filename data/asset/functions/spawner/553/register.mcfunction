...
execute unless data storage randomizer: Pos unless loaded 435 47 136 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 553
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [435, 47, 136]
