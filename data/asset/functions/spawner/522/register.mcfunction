...
execute unless data storage randomizer: Pos unless loaded -105 56 -14 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 522
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-105, 56, -14]
