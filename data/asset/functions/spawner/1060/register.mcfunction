...
execute unless data storage randomizer: Pos unless loaded -431 104 83 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1060
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-431, 104, 83]
