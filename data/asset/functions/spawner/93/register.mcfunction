...
execute unless data storage randomizer: Pos unless loaded 69 -4 42 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 93
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [69, -4, 42]
