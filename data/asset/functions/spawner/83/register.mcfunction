...
execute unless data storage randomizer: Pos unless loaded 161 12 -11 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 83
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [161, 12, -11]
