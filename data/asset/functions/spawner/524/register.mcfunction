...
execute unless data storage randomizer: Pos unless loaded 416 92 97 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 524
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [416, 92, 97]
