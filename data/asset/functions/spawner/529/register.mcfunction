...
execute unless data storage randomizer: Pos unless loaded 434 92 59 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 529
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [434, 92, 59]
