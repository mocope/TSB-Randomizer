...
execute unless data storage randomizer: Pos unless loaded -196 222 200 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 743
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-196, 222, 200]
