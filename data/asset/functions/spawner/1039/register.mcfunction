...
execute unless data storage randomizer: Pos unless loaded -481 122 33 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1039
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-481, 122, 33]
