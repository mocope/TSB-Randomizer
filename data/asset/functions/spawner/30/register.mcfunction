...
execute unless data storage randomizer: Pos unless loaded -83 6 55 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 30
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-83, 6, 55]
