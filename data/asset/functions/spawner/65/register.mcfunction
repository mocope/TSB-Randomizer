...
execute unless data storage randomizer: Pos unless loaded 77 7 -127 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 65
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [77, 7, -127]
