...
execute unless data storage randomizer: Pos unless loaded -132 42 -12 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 513
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-132, 42, -12]
