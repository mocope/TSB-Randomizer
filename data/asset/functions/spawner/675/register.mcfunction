...
execute unless data storage randomizer: Pos unless loaded -184 183 -332 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 675
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-184, 183, -332]
