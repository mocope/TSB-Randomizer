...
execute unless data storage randomizer: Pos unless loaded -227 82 9 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 390
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-227, 82, 9]
