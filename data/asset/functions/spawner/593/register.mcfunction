...
execute unless data storage randomizer: Pos unless loaded 159 145 -178 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 593
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [159, 145, -178]
