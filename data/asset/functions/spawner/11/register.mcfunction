...
execute unless data storage randomizer: Pos unless loaded 92 7 133 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 11
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [92, 7, 133]
