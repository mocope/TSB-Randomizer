...
execute unless data storage randomizer: Pos unless loaded 21 85 -415 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1118
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [21, 85, -415]
