...
execute unless data storage randomizer: Pos unless loaded -319 131 -173 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 707
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-319, 131, -173]
