...
execute unless data storage randomizer: Pos unless loaded -195 210 -309 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 639
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-195, 210, -309]
