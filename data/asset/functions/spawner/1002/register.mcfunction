...
execute unless data storage randomizer: Pos unless loaded -421 77 33 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1002
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-421, 77, 33]
