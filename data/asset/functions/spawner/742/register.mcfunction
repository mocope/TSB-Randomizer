...
execute unless data storage randomizer: Pos unless loaded -200 222 176 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 742
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-200, 222, 176]
