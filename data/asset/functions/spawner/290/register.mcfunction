...
execute unless data storage randomizer: Pos unless loaded -67 230 400 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 290
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-67, 230, 400]
