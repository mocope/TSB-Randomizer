...
execute unless data storage randomizer: Pos unless loaded 189 145 -179 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 606
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [189, 145, -179]
