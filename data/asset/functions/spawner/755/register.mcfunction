...
execute unless data storage randomizer: Pos unless loaded -193 187 156 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 755
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-193, 187, 156]
