...
execute unless data storage randomizer: Pos unless loaded 255 72 -208 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 340
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [255, 72, -208]
