...
execute unless data storage randomizer: Pos unless loaded 98 168 -549 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1072
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [98, 168, -549]
