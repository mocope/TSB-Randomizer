...
execute unless data storage randomizer: Pos unless loaded -230 101 1 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 391
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-230, 101, 1]
