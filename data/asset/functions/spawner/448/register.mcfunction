...
execute unless data storage randomizer: Pos unless loaded 270 54 242 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 448
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [270, 54, 242]
