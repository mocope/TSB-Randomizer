...
execute unless data storage randomizer: Pos unless loaded -163 169 -337 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 691
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-163, 169, -337]
