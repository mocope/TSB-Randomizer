...
execute unless data storage randomizer: Pos unless loaded -15 8 40 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 90
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-15, 8, 40]
