...
execute unless data storage randomizer: Pos unless loaded 170 10 -38 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 76
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [170, 10, -38]
