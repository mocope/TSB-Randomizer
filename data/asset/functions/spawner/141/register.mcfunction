...
execute unless data storage randomizer: Pos unless loaded 145 49 -179 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 141
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [145, 49, -179]
