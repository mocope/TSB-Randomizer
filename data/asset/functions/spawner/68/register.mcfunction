...
execute unless data storage randomizer: Pos unless loaded 90 17 -123 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 68
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [90, 17, -123]
