...
execute unless data storage randomizer: Pos unless loaded 123 149 -512 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 988
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [123, 149, -512]
