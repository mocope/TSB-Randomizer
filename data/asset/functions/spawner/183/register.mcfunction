...
execute unless data storage randomizer: Pos unless loaded -4 19 168 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 183
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-4, 19, 168]
