...
execute unless data storage randomizer: Pos unless loaded -481 104 33 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1062
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-481, 104, 33]
