...
execute unless data storage randomizer: Pos unless loaded -76 173 174 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 435
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-76, 173, 174]
