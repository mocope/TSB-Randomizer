...
execute unless data storage randomizer: Pos unless loaded 206 15 -8 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 84
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [206, 15, -8]
