...
execute unless data storage randomizer: Pos unless loaded -29 39 -152 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 54
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-29, 39, -152]
