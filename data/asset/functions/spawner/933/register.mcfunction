...
execute unless data storage randomizer: Pos unless loaded 208 119 -345 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 933
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [208, 119, -345]
