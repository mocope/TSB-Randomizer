...
execute unless data storage randomizer: Pos unless loaded 207 113 -364 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 956
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [207, 113, -364]
