...
execute unless data storage randomizer: Pos unless loaded 41 131 243 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 857
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [41, 131, 243]
