...
execute unless data storage randomizer: Pos unless loaded 15 21 -65 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 3
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [15, 21, -65]
