...
execute unless data storage randomizer: Pos unless loaded 170 100 286 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 477
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [170, 100, 286]
