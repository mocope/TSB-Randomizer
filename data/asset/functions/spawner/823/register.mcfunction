...
execute unless data storage randomizer: Pos unless loaded 68 74 113 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 823
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [68, 74, 113]
