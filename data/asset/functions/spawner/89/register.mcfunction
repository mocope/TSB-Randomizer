...
execute unless data storage randomizer: Pos unless loaded -25 8 28 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 89
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-25, 8, 28]
