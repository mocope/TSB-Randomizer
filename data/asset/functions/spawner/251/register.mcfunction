...
execute unless data storage randomizer: Pos unless loaded -149 57 -153 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 251
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-149, 57, -153]
