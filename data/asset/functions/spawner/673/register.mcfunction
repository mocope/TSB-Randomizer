...
execute unless data storage randomizer: Pos unless loaded -168 178 -325 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 673
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-168, 178, -325]
