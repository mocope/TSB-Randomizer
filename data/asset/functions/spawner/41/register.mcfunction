...
execute unless data storage randomizer: Pos unless loaded -61 35 -68 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 41
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-61, 35, -68]
