...
execute unless data storage randomizer: Pos unless loaded -218 214 378 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1129
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-218, 214, 378]
