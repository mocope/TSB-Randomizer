...
execute unless data storage randomizer: Pos unless loaded -481 131 33 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1044
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-481, 131, 33]
