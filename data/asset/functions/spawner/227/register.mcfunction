...
execute unless data storage randomizer: Pos unless loaded -129 47 61 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 227
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-129, 47, 61]
