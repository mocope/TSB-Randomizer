...
execute unless data storage randomizer: Pos unless loaded 230 44 254 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 446
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [230, 44, 254]
