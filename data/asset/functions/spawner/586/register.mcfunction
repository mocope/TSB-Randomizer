...
execute unless data storage randomizer: Pos unless loaded 453 216 -162 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 586
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [453, 216, -162]
