...
execute unless data storage randomizer: Pos unless loaded 478 117 -132 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 563
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [478, 117, -132]
