...
execute unless data storage randomizer: Pos unless loaded -276 81 173 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 413
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-276, 81, 173]
