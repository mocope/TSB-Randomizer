...
execute unless data storage randomizer: Pos unless loaded 35 54 347 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 501
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [35, 54, 347]
