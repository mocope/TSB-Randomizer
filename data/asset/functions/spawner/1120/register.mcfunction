...
execute unless data storage randomizer: Pos unless loaded -10 85 -376 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1120
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-10, 85, -376]
