...
execute unless data storage randomizer: Pos unless loaded 90 138 1947 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 929
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [90, 138, 1947]
...
# SpawnPotentials(int | int[] | ({ Weight: int, Id: int })[]) MobAssetのIDを指定する
    data modify storage asset:spawner SpawnPotentials set value [265,155,201,156]
# 一度に召喚する数 (int)
