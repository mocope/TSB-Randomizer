...
execute unless data storage randomizer: Pos unless loaded -162 210 -343 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 640
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-162, 210, -343]
