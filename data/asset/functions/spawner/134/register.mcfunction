...
execute unless data storage randomizer: Pos unless loaded 7 21 -200 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 134
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [7, 21, -200]
