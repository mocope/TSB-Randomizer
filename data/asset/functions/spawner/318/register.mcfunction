...
execute unless data storage randomizer: Pos unless loaded -59 80 397 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 318
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-59, 80, 397]
