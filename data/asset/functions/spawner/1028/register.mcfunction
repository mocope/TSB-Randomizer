...
execute unless data storage randomizer: Pos unless loaded -446 94 38 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1028
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-446, 94, 38]
