...
execute unless data storage randomizer: Pos unless loaded 482 72 -128 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 558
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [482, 72, -128]
