...
execute unless data storage randomizer: Pos unless loaded 30 87 371 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 512
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [30, 87, 371]
