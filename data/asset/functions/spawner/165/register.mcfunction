...
execute unless data storage randomizer: Pos unless loaded -75 82 -37 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 165
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-75, 82, -37]
