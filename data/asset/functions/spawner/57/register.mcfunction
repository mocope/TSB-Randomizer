...
execute unless data storage randomizer: Pos unless loaded -54 42 -161 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 57
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-54, 42, -161]
