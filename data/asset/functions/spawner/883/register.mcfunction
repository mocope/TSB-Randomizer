...
execute unless data storage randomizer: Pos unless loaded 81 172 351 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 883
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [81, 172, 351]
