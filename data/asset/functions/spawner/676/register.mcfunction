...
execute unless data storage randomizer: Pos unless loaded -188 183 -359 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 676
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-188, 183, -359]
