...
execute unless data storage randomizer: Pos unless loaded -149 56 -122 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 244
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-149, 56, -122]
