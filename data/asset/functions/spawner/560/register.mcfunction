...
execute unless data storage randomizer: Pos unless loaded 482 80 -135 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 560
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [482, 80, -135]
