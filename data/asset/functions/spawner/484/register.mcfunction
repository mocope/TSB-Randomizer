...
execute unless data storage randomizer: Pos unless loaded 151 106 287 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 484
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [151, 106, 287]
