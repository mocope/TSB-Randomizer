...
execute unless data storage randomizer: Pos unless loaded -189 86 397 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 784
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-189, 86, 397]
