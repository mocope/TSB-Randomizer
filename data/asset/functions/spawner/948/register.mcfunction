...
execute unless data storage randomizer: Pos unless loaded 153 139 -387 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 948
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [153, 139, -387]
