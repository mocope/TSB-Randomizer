...
execute unless data storage randomizer: Pos unless loaded 85 158 -240 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 382
# Pos ([int] @ 3)
