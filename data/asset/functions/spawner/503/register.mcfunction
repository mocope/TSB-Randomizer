...
execute unless data storage randomizer: Pos unless loaded 0 60 354 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 503
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [0, 60, 354]
