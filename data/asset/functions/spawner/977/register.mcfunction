...
execute unless data storage randomizer: Pos unless loaded 90 162 -436 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 977
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [90, 162, -436]
