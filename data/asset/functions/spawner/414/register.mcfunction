...
execute unless data storage randomizer: Pos unless loaded -243 93 155 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 414
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-243, 93, 155]
