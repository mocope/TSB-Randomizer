...
execute unless data storage randomizer: Pos unless loaded 73 157 429 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 889
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [73, 157, 429]
