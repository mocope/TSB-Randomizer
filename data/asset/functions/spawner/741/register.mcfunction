...
execute unless data storage randomizer: Pos unless loaded -183 227 173 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 741
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-183, 227, 173]
