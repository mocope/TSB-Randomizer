...
execute unless data storage randomizer: Pos unless loaded -413 67 58 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 995
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-413, 67, 58]
