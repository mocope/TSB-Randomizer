...
execute unless data storage randomizer: Pos unless loaded 210 152 -46 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 279
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [210, 152, -46]
