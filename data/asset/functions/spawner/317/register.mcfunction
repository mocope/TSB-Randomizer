...
execute unless data storage randomizer: Pos unless loaded -67 91 382 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 317
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-67, 91, 382]
