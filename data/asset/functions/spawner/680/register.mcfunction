...
execute unless data storage randomizer: Pos unless loaded -199 178 -386 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 680
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-199, 178, -386]
