...
execute unless data storage randomizer: Pos unless loaded 68 -3 225 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 199
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [68, -3, 225]
