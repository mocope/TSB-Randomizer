...
execute unless data storage randomizer: Pos unless loaded 311 42 -80 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 465
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [311, 42, -80]
