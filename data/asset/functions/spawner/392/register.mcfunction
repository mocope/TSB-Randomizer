...
execute unless data storage randomizer: Pos unless loaded -240 100 -9 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 392
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-240, 100, -9]
