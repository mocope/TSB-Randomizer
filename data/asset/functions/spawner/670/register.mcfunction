...
execute unless data storage randomizer: Pos unless loaded -135 183 -322 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 670
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-135, 183, -322]
