...
execute unless data storage randomizer: Pos unless loaded -67 24 -69 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 45
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-67, 24, -69]
