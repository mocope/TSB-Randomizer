...
execute unless data storage randomizer: Pos unless loaded 47 148 219 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 860
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [47, 148, 219]
