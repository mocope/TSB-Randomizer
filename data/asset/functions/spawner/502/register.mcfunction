...
execute unless data storage randomizer: Pos unless loaded 8 54 348 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 502
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [8, 54, 348]
