...
execute unless data storage randomizer: Pos unless loaded 486 117 -130 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 564
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [486, 117, -130]
