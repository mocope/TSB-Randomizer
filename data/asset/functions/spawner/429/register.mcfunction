...
execute unless data storage randomizer: Pos unless loaded -65 177 175 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 429
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-65, 177, 175]
