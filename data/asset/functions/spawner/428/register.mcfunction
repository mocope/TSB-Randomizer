...
execute unless data storage randomizer: Pos unless loaded -286 41 159 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 428
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-286, 41, 159]
