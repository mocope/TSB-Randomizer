...
execute unless data storage randomizer: Pos unless loaded 9 66 354 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 504
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [9, 66, 354]
