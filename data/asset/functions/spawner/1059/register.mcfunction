...
execute unless data storage randomizer: Pos unless loaded -443 171 71 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 1059
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-443, 171, 71]
