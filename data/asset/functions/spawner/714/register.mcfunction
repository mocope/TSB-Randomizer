...
execute unless data storage randomizer: Pos unless loaded -280 204 -178 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 714
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-280, 204, -178]
