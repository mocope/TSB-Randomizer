...
execute unless data storage randomizer: Pos unless loaded 207 139 -374 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 945
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [207, 139, -374]
