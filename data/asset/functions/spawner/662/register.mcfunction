...
execute unless data storage randomizer: Pos unless loaded -205 197 -336 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 662
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-205, 197, -336]
