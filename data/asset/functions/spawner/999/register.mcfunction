...
execute unless data storage randomizer: Pos unless loaded -439 67 97 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 999
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-439, 67, 97]
