...
execute unless data storage randomizer: Pos unless loaded -76 81 393 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 319
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-76, 81, 393]
