...
execute unless data storage randomizer: Pos unless loaded 9 37 -208 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 128
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [9, 37, -208]
