...
execute unless data storage randomizer: Pos unless loaded 265 119 408 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 794
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [265, 119, 408]
