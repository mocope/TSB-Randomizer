...
execute unless data storage randomizer: Pos unless loaded 80 96 -251 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 346
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [80, 96, -251]
