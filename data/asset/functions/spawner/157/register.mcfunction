...
execute unless data storage randomizer: Pos unless loaded -76 -11 153 run return 1

# ID (int)
    data modify storage asset:spawner ID set value 157
# Pos ([int] @ 3)
    data modify storage asset:spawner Pos set value [-76, -11, 153]
